...
define ("DB_HOST", "182.50.131.192"); // set database host
define ("DB_USER", "bablu"); // set database user
define ("DB_PASS","Shreeram@831"); // set database password
define ("DB_NAME","bablu"); // set database name
